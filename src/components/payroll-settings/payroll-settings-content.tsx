...
// "Fixed salary" IS a valid per-course override (see OfferingCalcMethod in
// staff-payments.ts), but it needs its own amount entered per assistant —
// there's no single shared amount to bulk-apply to a whole course's worth of
// people at once, so it's excluded from just this bulk picker. Setting it
// for one assistant at a time lives in Finance's Payments tab instead.
