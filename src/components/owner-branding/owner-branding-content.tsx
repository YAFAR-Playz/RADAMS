...
import {
  ...
  uploadPlatformDefaultLogo,
  removePlatformDefaultLogo,
  type BrandingDraft,
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-[1.25fr_1fr]">
            ...
            <div className="flex items-center gap-[15px]">
              ...
              >
                {logoUploading ? (
                  ...
                  <img src={draft.logoUrl} alt="Default logo" className="h-full w-full object-contain" />
                ) : (
                  logoLetter
                )}
              </div>
              <div className="flex flex-col gap-[8px]">
                ...
                <span className="text-[11.5px] leading-[1.4] text-[var(--subtle)]">
                  PNG, JPG, SVG or WEBP, up to 2MB. {draft.logoUrl ? "Used by every org without its own logo." : "Orgs without their own logo show a letter avatar instead."}
                </span>
              </div>
            </div>
            <div className="mt-4">
              <label className="mb-[7px] block text-[12.5px] font-semibold text-[var(--text)]">Default brand name</label>
              <input
                value={draft.name}
        ...
        <aside className="min-w-0 lg:sticky lg:top-[18px] lg:self-start">
          ...
          <p className="m-0 mt-[11px] px-1 text-[11.5px] leading-[1.5] text-[var(--subtle)]">
            Any organization without its own branding sees these colors, font and shape.
          </p>
        </aside>
      </div>
